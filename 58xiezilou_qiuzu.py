...
class P58_Cs:
    ...
    def img_post(self, name='a96196ceba58574c492bbd65348b312e.jpg'):
        import base64
        import requests
        import json
    ...
    def img(self):
        d = webdriver.Chrome('')
        time.sleep(5)
        d.get('http://post.58.com/fang/2/13/s5')
        e = d.find_element_by_xpath('//*[@id="flLogin_pwdLogin"]/i')
        if e:
            e.click()
        ...
        d.get('http://post.58.com/fang/2/13/s5')
        time.sleep(5)
        d.find_element_by_xpath('//*[@id="imgUpload"]/div/input').send_keys(
            'C:\\Users\Admin\Pictures\Saved Pictures\\a96196ceba58574c492bbd65348b312e.jpg')
        time.sleep(2)
    ...
    def put(self, item):
        ...
        headers = {
            ...
            'Referer': 'http://sh.58.com/ershoufang/?PGTID=0d200001-0000-2bfd-99d0-5868eeca3292&ClickID=1',
