...
class Baixing_Cs():
    ...
    def img(self):
        img_list = []
        url_1 = 'http://v0.api.upyun.com/bximg/'
        files_name = [r'C:\Users\Admin\Pictures\Saved Pictures\3b87e950352ac65ca217f7fbf1f2b21193138a2c.jpg',
                      r'C:\Users\Admin\Pictures\Saved Pictures\3b87e950352ac65ca217f7fbf1f2b21193138a2c.jpg',
                      ]
        for file in files_name:
            files = {'file': ('timg.jpg', open(file, 'rb'), 'image/jpeg')}
            data_1 = {
                "policy": '''
    ''',
                "signature": '''07ddbf76a38ef44bddbd1078a0b2552e
    '''
            }
            res1 = requests.post(url=url_1, data=data_1, files=files)
            res2 = json.loads(res1.content.decode())
            print(res2)
            img_list.append(res2["url"])
            self.image = img_list
        print(self.image)
    def put(self, item):
