...
#     time.sleep(5)
#     d.get('http://agent.sofang.com/oldsalemanage/house/releaseed')
#     time.sleep(5)
#     r = d.find_element_by_xpath('//*[@id="all"]')
#     if r:
#         r.click()
#     time.sleep(1)
#     d.find_element_by_xpath('//*[@id="main_r"]/div[4]/input[1]').click()
#
#     time.sleep(5)
#     d.get('http://agent.sofang.com/oldrentmanage/house/releaseed')
#     time.sleep(5)
...
#
#     time.sleep(5)
#     d.get('http://agent.sofang.com/oldrentmanage/office/releaseed')
#     time.sleep(5)
#     r = d.find_element_by_xpath('//*[@id="all"]')
#     if r:
#         r.click()
...
#
#     time.sleep(5)
#     d.get('http://agent.sofang.com/oldsalemanage/office/releaseed')
#     time.sleep(5)
#     r = d.find_element_by_xpath('//*[@id="all"]')
#     if r:
#         r.click()
...
"title":"正式好不好你据斤斤计格erty计格法给较斤计斤斤sdfg计较斤斤计较",
