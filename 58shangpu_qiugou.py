...
class P58_Cs:
    ...
    def ld(self, city_id, area, diduan=""):
        response = requests.get(
            'http://post.58.com/fang/{}/14/s5'.format(city_id)).content.decode()
        #                              城市
        res = etree.HTML(response)
    ...
    def img(self, name):
        ...
        time.sleep(5)
        d.get('http://post.58.com/fang/2/14/s5')
        time.sleep(5)
    ...
    def put(self, item):
        ...
        url = 'http://post.58.com/fang/{}/14/s5/submit'.format(city_id)
...
item["起租期"] = "1"
item["免租期"] = "9"
item["标题"] = "汇佳大厦200平方商铺低价出售"
item["描述"] = "配套齐全汇佳大厦200平方写字楼低价出售"
item["联系人"] = "鱼先生"
