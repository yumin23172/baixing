...
class BianmingSpider(scrapy.Spider):
    ...
    start_urls = ['http://esf.wangjing.cn/index.php?type=sale&realtype=8&page={}'.format(n for n in range(1,8))]
    ...
    def parse(self, response):
        ...
        for li in li_list:
            ...
            item["size"] = li.xpath(".//div[@class='area']").extract()
            ...
            item["price"] = li.xpath("//div[@class='price']//text()").extract()
